...
class TestName(unittest.TestCase):
    ...
    def test_adding_process(self):
        test1 = print("sorry, but " + self.correct_g + " is already present in the database, thank you anyway")
        self.assertEqual(test1, a.add_element(self.correct_g))
        test2 = print("sorry, but " + self.correct_b + " is already present in the database, thank you anyway")
    ...
    def test_database(self):
        self.assertEqual(d.database(self.dictionary, self.csv_name),print("database created successfully "))
